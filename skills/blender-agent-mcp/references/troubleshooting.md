...
| `need at least 2 projectable points, got 1 (11 dropped). Is the viewport looking at the object?` | Stroke points project behind the view camera | Orbit/frame the object, screenshot to confirm, then re-issue the stroke. |
